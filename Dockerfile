...
RUN curl -O 'https://edownloads.tibco.com/Installers/tap/EMS-CE/10.1.0/TIB_ems-ce_10.1.0_linux_x86_64.zip?SJCDPTPG=1650093208_ec70b69ca67baecfcc555a3b92a80a1b&ext=.zip'
RUN unzip TIB*
